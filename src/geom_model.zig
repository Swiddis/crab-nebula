...
const LM_C = [_][]f64{
    [_]f64{ 0.002371689729464756, -0.01175063275814122, -0.004677450433681569, -0.001769238215211349 },
    [_]f64{ 0.03072274917592544, -0.16347768857509365, 0.1255044242446921, -0.3384423086503297 },
    [_]f64{ -0.00018331717634889556, 0.00019362994587639144, 0.00046145019151840305, 0.00027186889711218665 },
    [_]f64{ 0.0001540268677457221, -0.0012762351705975653, 0.0005535754569780775, -0.0006045287971515022 },
};
const LM_I = [_]f64{ 0.5729724241422721, 17.187043418429347, 1.0405148201323577, -0.026545166796745227 };
...
pub fn logistic(t: f64, source_target_dist: f64, source_r: f64, target_r: f64, fleet_size: f64) f64 {
    const t0 = source_target_dist * LM_C[0][0] + source_r * LM_C[0][1] + target_r * LM_C[0][2] + fleet_size * LM_C[0][3] + LM_I[0];
    const k = source_target_dist * LM_C[1][0] + source_r * LM_C[1][1] + target_r * LM_C[1][2] + fleet_size * LM_C[1][3] + LM_I[1];
